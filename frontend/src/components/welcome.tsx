          ...
          <div className="text-center space-y-8 mb-16">
            ...
            <div className="space-y-4 animate-fade-in">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
                An advanced platform for translating and editing Tibetan texts
                with real-time collaboration, parallel text editing, and
            ...
            <div className="flex justify-center pt-4">
              {!isButtonReady ? (
                <div className="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold text-lg rounded-2xl shadow-2xl opacity-75 cursor-not-allowed">
                  <svg
